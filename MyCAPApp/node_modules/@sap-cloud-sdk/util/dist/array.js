 ...
 */
function flat(arr) {
    return arr.reduce(function (flattened, subArr) { return __spreadArray(__spreadArray([], flattened), subArr); }, []);
}
exports.flat = flat;
/**
...
function variadicArgumentToArray(firstOrArray, rest) {
    if (Array.isArray(firstOrArray)) {
        return __spreadArray(__spreadArray([], firstOrArray), rest);
    }
    return firstOrArray ? __spreadArray([firstOrArray], rest) : __spreadArray([], rest);
}
...
function zip(left, right) {
    ...
    return longerArr.reduce(function (zipped, _, i) {
        ...
        return __spreadArray(__spreadArray([], zipped), currentZipped);
    }, []);
}
exports.zip = zip;
/**
...
function partition(arr, condition) {
    return arr.reduce(function (_a, item) {
        ...
        return condition(item)
            ? [__spreadArray(__spreadArray([], conditionTrue), [item]), conditionFalse]
            : [conditionTrue, __spreadArray(__spreadArray([], conditionFalse), [item])];
    }, [[], []]);
}
