...
function needsAuthHeaders(destination) {
...
function getCustomAuthHeaders(destination, customHeaders) {
    if (destination.authentication === 'PrincipalPropagation') {
        return util_1.pickIgnoreCase(customHeaders, 'SAP-Connectivity-Authentication');
    }
    return util_1.pickIgnoreCase(customHeaders, 'authorization');
}
function getAuthHeaders(destination, customHeaders) {
    return __awaiter(this, void 0, void 0, function () {
        var customAuthHeaders;
        return __generator(this, function (_a) {
            customAuthHeaders = getCustomAuthHeaders(destination, customHeaders);
...
function headerFromTokens(authenticationType, authTokens) {
    ...
    if (!usableTokens.length) {
        ...
        ], authTokens.map(function (token) { return token.error; })).join(util_1.unixEOL));
    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            switch (destination.authentication) {
                ...
                default:
                    throw Error("The destination used \"" + destination.authentication + "\" as authentication type which is not supported by the SDK.");
            }
            return [2 /*return*/];
        });
    });
