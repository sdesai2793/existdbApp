...
function userGivenName(jwtPayload) {
    if (exports.mappingUserFields.givenName) {
        return jwt_1.readPropertyWithWarn(jwtPayload, exports.mappingUserFields.givenName.keyInJwt);
    }
}
...
function userFamilyName(jwtPayload) {
    if (exports.mappingUserFields.familyName) {
        return jwt_1.readPropertyWithWarn(jwtPayload, exports.mappingUserFields.familyName.keyInJwt);
    }
}
...
function userEmail(jwtPayload) {
    if (exports.mappingUserFields.email) {
        return jwt_1.readPropertyWithWarn(jwtPayload, exports.mappingUserFields.email.keyInJwt);
    }
}
...
function userId(jwtPayload) {
    return jwt_1.readPropertyWithWarn(jwtPayload, exports.mappingUserFields.id.keyInJwt);
}
