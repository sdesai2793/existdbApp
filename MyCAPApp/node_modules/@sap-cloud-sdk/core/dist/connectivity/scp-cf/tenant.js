...
function tenantId(jwtPayload) {
    return jwt_1.readPropertyWithWarn(jwtPayload, exports.mappingTenantFields.id.keyInJwt);
}
...
function tenantName(jwtPayload) {
    var extAttr = jwt_1.readPropertyWithWarn(jwtPayload, 'ext_attr');
    if (extAttr) {
...
function tenantFromJwt(jwtPayload) {
    jwt_1.checkMandatoryValue('id', exports.mappingTenantFields, jwtPayload);
    return {
...
function isIdenticalTenant(userTokenPayload, providerTokenPayload) {
    return (jwt_1.readPropertyWithWarn(userTokenPayload, exports.mappingTenantFields.id.keyInJwt) ===
        jwt_1.readPropertyWithWarn(providerTokenPayload, exports.mappingTenantFields.id.keyInJwt));
}
