...
var DestinationFromServiceRetriever = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7:
                        if (!(destination.authentication === 'OAuth2ClientCredentials')) return [3 /*break*/, 9];
                        return [4 /*yield*/, da.addOAuth2ClientCredentials()];
                    case 8:
                        destination = _a.sent();
                        _a.label = 9;
                    case 9:
                        if (!(destination.authentication === 'OAuth2JWTBearer')) return [3 /*break*/, 11];
                        return [4 /*yield*/, da.fetchDestinationByUserJwt()];
                    case 10:
                        destination = _a.sent();
                        _a.label = 11;
                    case 11:
                        if (!(destination.authentication === 'ClientCertificateAuthentication')) return [3 /*break*/, 13];
                        return [4 /*yield*/, da.addClientCertAuth()];
                    case 12:
                        destination = _a.sent();
                        _a.label = 13;
                    case 13: return [4 /*yield*/, da.addProxyConfiguration(destination)];
                    case 14:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = {};
                        return [4 /*yield*/, token_accessor_1.jwtBearerToken(this.options.userJwt, environment_accessor_1.getDestinationService(), this.options)];
    ...
    DestinationFromServiceRetriever.prototype.addOAuth2ClientCredentials = function () {
        return __awaiter(this, void 0, void 0, function () {
            var clientGrant;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        clientGrant = _a.sent();
                        return [2 /*return*/, destination_service_1.fetchDestination(this.destinationServiceCredentials.uri, clientGrant, this.name)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4: return [2 /*return*/, this.fetchDestinationByUserJwt()];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, token_accessor_1.jwtBearerToken(this.options.userJwt, destinationService, this.options)];
                    case 1:
                        accessToken = _a.sent();
    ...
    DestinationFromServiceRetriever.prototype.isProviderAndSubscriberSameTenant = function () {
        return (this.decodedUserJwt &&
            tenant_1.isIdenticalTenant(this.decodedUserJwt, this.decodedProviderClientCredentialsToken));
    };
