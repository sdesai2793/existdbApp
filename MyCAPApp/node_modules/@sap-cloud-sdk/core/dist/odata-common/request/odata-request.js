...
var ODataRequest = /** @class */ (function () {
    ...
    ODataRequest.prototype.url = function () {
        return "" + remove_slashes_1.removeTrailingSlashes(this.resourceUrl()) + this.config.appendedPaths.join('') + this.query();
    };
    /**
    ...
    ODataRequest.prototype.relativeUrl = function (includeServicePath) {
        ...
        return "" + remove_slashes_1.removeTrailingSlashes(this.relativeResourceUrl(includeServicePath)) + this.config.appendedPaths.join('') + this.query();
    };
    /**
    ...
    ODataRequest.prototype.defaultHeaders = function () {
        var customDefaultHeaders = util_1.pickIgnoreCase.apply(void 0, __spreadArray([this.customHeaders()], Object.keys(this.config.defaultHeaders)));
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _b = [destination];
                        _c = [__assign({}, http_client_1.filterCustomRequestConfig(this.config.customRequestConfiguration))];
                        _d = {};
                        return [4 /*yield*/, this.headers()];
                    case 1: return [2 /*return*/, _a.apply(void 0, _b.concat([__assign.apply(void 0, _c.concat([(_d.headers = _e.sent(), _d.url = this.relativeUrl(), _d.method = this.config.method, _d.data = this.config.payload, _d)])), { fetchCsrfToken: this.config.fetchCsrfToken }])).catch(function (error) {
