...
exports.GetAllRequestBuilderV2 = exports.GetAllRequestBuilder = void 0;
...
var GetAllRequestBuilder = /** @class */ (function (_super) {
    ...
    GetAllRequestBuilder.prototype.filter = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
        this.requestConfig.filter = odata_common_1.and(util_1.variadicArgumentToArray(first, rest));
        return this;
    };
    return GetAllRequestBuilder;
}(odata_common_1.GetAllRequestBuilder));
exports.GetAllRequestBuilder = GetAllRequestBuilder;
exports.GetAllRequestBuilderV2 = GetAllRequestBuilder;
