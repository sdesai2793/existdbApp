...
function toSanitizedHeaderObject(key, value) {
    return util_1.toSanitizedObject(key, value);
}
...
function getHeader(key, headers) {
    ...
    return util_1.pickIgnoreCase(headers, key);
}
...
function getHeaders(keys, headers) {
    if (headers === void 0) { headers = {}; }
    return util_1.pickIgnoreCase.apply(void 0, __spreadArray([headers], keys));
}
...
function getHeaderValue(key, headers) {
    if (headers === void 0) { headers = {}; }
    return util_1.pickValueIgnoreCase(headers, key);
}
...
function filterNullishValues(headers) {
    if (headers === void 0) { headers = {}; }
    return util_1.pickNonNullish(headers);
}
...
function replaceDuplicateKeys(headers, customHeaders) {
    ...
    return util_1.mergeLeftIgnoreCase(headers, customHeaders);
}
...
function mergeHeaders(headers, customHeaders) {
    if (headers === void 0) { headers = {}; }
    if (customHeaders === void 0) { customHeaders = {}; }
    return util_1.mergeIgnoreCase(headers, customHeaders);
}
